<footer class="footer bg-lighter" id="footer">
    <div class="container">
            ...
            <div class="col-md-3">
                <div class="footer-logo">
                    <a href="html/index.html" class="logo-link">
                        <img class="logo-light logo-img" src="/themes/site/default/assets/images/logo.png" srcset="/themes/site/default/assets/images/logo2x.png 2x" alt="logo">
                        <img class="logo-dark logo-img" src="/themes/site/default/assets/images/logo-dark.png" srcset="/themes/site/default/assets/images/logo-dark2x.png 2x" alt="logo-dark">
                    </a>
                </div><!-- .footer-logo -->
            </div><!-- .col -->
        ...
        <div class="row g-3 align-items-center justify-content-md-between py-4">
            <div class="col-md-8">
                <div class="text-base">Copyright &copy; 2024 DashLite. Template Made by <a class="text-base fw-bold" href="#">Softnio</a></div>
            </div><!-- .col -->
