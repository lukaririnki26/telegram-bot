            ...
            <div class="row align-items-center justify-content-lg-between g-gs">
                <div class="col-lg-5">
                    <div class="img-block img-block-s1 left">
                        <img src="/themes/site/default/assets/images/gfx/a.png" alt="img">
                    </div><!-- .img-block -->
                </div><!-- .col -->
                <div class="col-lg-6">
            ...
            <div class="row flex-row-reverse align-items-center justify-content-between g-gs">
                <div class="col-lg-5">
                    <div class="img-block img-block-s1 right">
                        <img src="/themes/site/default/assets/images/gfx/b.png" alt="img">
                    </div><!-- .img-block -->
                </div><!-- .col -->
                <div class="col-lg-6">
    ...
    <section class="section section-feature">
        <div class="container">
            <div class="row align-items-center justify-content-between g-gs">
                <div class="col-lg-5">
                    <div class="img-block img-block-s1 left">
                        <img src="/themes/site/default/assets/images/gfx/c.png" alt="img">
                    </div>
                </div><!-- .col -->
                <div class="col-lg-6">
                    <div class="text-block">
                            ...
                            <div class="review review-s2">
                                <div class="review-portrait review-portrait-s1">
                                    <div class="portrait portrait-s1">
                                        <img src="/themes/site/default/assets/images/client/client-a.png" alt="">
                                    </div>
                                </div>
                                <div class="review-content">
                                    <div class="review-rating rating rating-sm">
                    ...
                    <div class="card card-shadow round-xl">
                        <div class="card-inner card-inner-lg">
                            <div class="review review-s2">
                                <div class="review-portrait review-portrait-s1">
                                    <div class="portrait portrait-s1">
                                        <img src="/themes/site/default/assets/images/client/client-b.png" alt="">
                                    </div>
                                </div>
                                <div class="review-content">
                                    <div class="review-rating rating rating-sm">
